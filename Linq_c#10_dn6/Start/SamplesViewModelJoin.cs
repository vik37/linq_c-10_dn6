...
{
  public class SamplesViewModelJoin : ViewModelBase
  {
    ...
    public List<ProductOrder> InnerJoinTwoFieldsQuery()
    {
      ...
      list = (from prod in products
              ...
              new {prod.ProductID, Qtu = (short)6}
                equals
              new { sale.ProductID, Qtu = sale.OrderQty}
              select new ProductOrder
              {
                  ProductID = prod.ProductID,
                  Name = prod.Name,
    ...
    public List<ProductOrder> InnerJoinTwoFieldsMethod()
    {
      ...
      list = products.Join(sales, 
                        prod => new {prod.ProductID,Qtu = (short)6},
                        sale => new {sale.ProductID,Qtu = sale.OrderQty},
                        (prod,sale) => new ProductOrder
                        {
                            ProductID = prod.ProductID,
                            Name = prod.Name,
    ...
    public List<ProductSales> JoinIntoMethod()
    {
      ...
      list = products.OrderBy(p  => p.ProductID).GroupJoin(sales,
            ...
            {
                Product = prod,
                Sales = sale.OrderBy(s => (int)s.SalesOrderID).ToList()
            }).ToList();
      return list;
    }
    #endregion
