...
{
  public class SamplesViewModelUion : ViewModelBase
  {
    ...
    public List<Product> UnionQuery()
    {
     ...
     list =  (from prod in list1 select prod)
                .Union(list2,pc).OrderByDescending(x  => x.Name).ToList();
    ...
    public List<Product> UnionMethod()
    {
      ...
      list = list1.Union(list2,pc).OrderByDescending(x => x.Name).ToList();
    ...
    public List<int> ConcatIntegersQuery()
    {
      ...
      list = (from num in list1 select num)
                .Concat(list2)
                .OrderByDescending(num => num).ToList();
